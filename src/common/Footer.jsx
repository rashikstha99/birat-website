...
const Footer = () => {
  return (
    <div className='relative overflow-hidden bg-gradient-to-br from-slate-50 to-zinc-300'>
        <div className="container py-2 flex flex-col lg:flex-row gap-10">
            <Image
                ...
                alt='Wave'
            />
            <div className="w-full lg:w-3/12 z-1">
                <Image
            ...
            <div className="w-full lg:w-9/12 flex flex-col gap-8 justify-center z-1">
                ...
                <div className="flex justify-start lg:justify-end items-center gap-10">
                ...
                <small className='text-secondary justify-start lg:justify-end w-full flex'>
